class Profile < ActiveRecord::Base
  ...
  attr_accessible :first_name, :last_name, :email, :phone, :district, :experience, :facebook_url, :facebook_no_of_friends, :twitter_url, :twitter_no_of_followers, :content_sample, :editorial_ideas, :key_issue_1, :key_issue_2, :key_issue_3, :media_formats, :equipment_access, :conflict_of_interest, :other_comments, :confirm_email
