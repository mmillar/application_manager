class Profile < ActiveRecord::Base
  ...
  validate :email_matches_its_confirmation, :bio_is_present, :picture_is_present, :address_is_present
  ...
  def address_is_present
    errors.add(:address, "can't be blank") if address.blank? && !new_record? && !bypass
    errors.add(:city, "can't be blank") if city.blank? && !new_record? && !bypass
    errors.add(:province, "can't be blank") if province.blank? && !new_record? && !bypass
    errors.add(:postal_code, "can't be blank") if postal_code.blank? && !new_record? && !bypass
  end
